  ...
  <q-page ref='page' class="page row">
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-9 section-padding ">
          <swiper :options="swiperOption" ref="mySwiper">
                ...
                <div class="row">
                  ...
                  <div class="col">
                    ...
                    <div class="overview-footer">今日游客数</div>
                      ...
                      <div class="col">
                    <div class="overview-quantity">
                      <countTo class='text-rl' :endVal="dayParkinglot" :duration="600" />
                    </div>
                    <div class="overview-footer">今日入园车辆</div>
                  </div>
                  <div class="col">
                    <div class="overview-quantity">
                      <countTo class='text-pl' :endVal="curParkinglot" :duration="600" />
                    </div>
            ...
            <swiper-slide>
              <div class="overview-box section-bg" style='padding:1.8vh 1vh'>
                <div class="overview-header">各停车场剩余停车位情况</div>
                <div class="row">
                  <div :key='index' v-for='(item,index) in parkings' class="col">
                    <div class="overview-quantity">                     
                      <countTo class='text-bl' :endVal="item.parkSumRuckSpace" :duration="600" />
                    </div>
                    <div class="overview-footer" style="font-size:.125rem">{{item.trackName}}</div>
                  </div>
                </div>
              </div>
            </swiper-slide>
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 section-padding">
          <div :key='platform.id' class="overview-box section-bg">
            ...
            <div class="row">
              <div class="col">
                <div class="overview-quantity">
                  <!-- <span class='text-pl'>{{guide.work}}</span> -->
              ...
              <div class="col">
                <div class="overview-quantity">
                  <!-- <span class="text-rl">{{guide.mountGuard}}</span> -->
              ...
              <div class="col">
                <div class="overview-quantity">
                  <!-- <span class="text-pl">{{guide.all}}</span> -->
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12-col-xl-12 section-padding">
          <div class="section-bg  section-padding" style="overflow:hidden">
            <swiper style="height:17vh;" :options="swiperOption1" ref="chartSwiper">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-2 col-xl-2 cust-col">
      <div class="fit column">
        <div class="col-2 full-wdith section-padding ">
          <div class="overview-box section-bg">
            <div class="overview-header">投诉建议</div>
            <div class="row">
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-pl' :endVal="complaint.dispose" :duration="600" />
                </div>
                <div class="overview-footer">已处理</div>
              </div>
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-rl' :endVal="complaint.untreated" :duration="600" />
                </div>
                <div class="overview-footer">未处理</div>
              </div>
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-pl' :endVal="complaint.all" :duration="600" />
                </div>
                <div class="overview-footer">全部</div>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    slideChange() {
      ...
      if (index == 0) index = 4;
      if (index == 5) index = 1;
      let scenicName = this.platforms[index].scenicName;
    },
    format(value) {
    ...
    initMap() {
      let _this = this;
      this.mapOptions = {
        center: this.platform.mapGaode.center.split(","),
        resizeEnable: true,
