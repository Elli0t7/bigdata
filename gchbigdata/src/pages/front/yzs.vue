        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-3 section-padding">
          <div :key='platform.id' class="overview-box section-bg">
            ...
            <div class="row">
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-pl' key="yzs_work" :endVal="gui.work" :duration="600" />
                </div>
                <div class="overview-footer">带团</div>
              </div>
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-rl' key='yzs_mountGuard' :endVal="gui.mountGuard" :duration="600" />
                </div>
                <div class="overview-footer">在岗</div>
              </div>
              <div class="col">
                <div class="overview-quantity">
                  <countTo class='text-pl' key="yzs_all" :endVal="gui.all" :duration="600" />
                </div>
      ...
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12-col-xl-12 section-padding">
          <div class="section-bg  section-padding" style="overflow:hidden">
            <swiper style="height:17.1vh;" :options="swiperOption1" ref="chartSwiper">
