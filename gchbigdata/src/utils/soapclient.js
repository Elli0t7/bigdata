            ...
            switch (typeof _pl[p]) {
                ...
                case "object":
                    xml +=
                        ...
                        p +
                        ">" +
                        SOAPClientParameters._serialize(_pl[p]) +
                        "</" +
                        p +
                        ">";
                    break;
        ...
        case "object":
            ...
            if (o.constructor.toString().indexOf("function Date()") > -1) {
                ...
                tzhours =
                    ...
                    tzhours.toString();
                var timezone =
                    (o.getTimezoneOffset() < 0 ? "+" : "-") + tzhours + ":" + tzminutes;
                s +=
                    year +
                    "-" +
                    month +
...
SOAPClient._sendSoapRequest = function(
    ...
    } else xmlHttp.open("POST", url, async);
    var soapaction =
    ...
    for (var i = 0; i < ell.length; i++) {
        if (useNamedItem) {
            ...
            if (
                ...
                wsdlTypes[ell[i].attributes["name"].value] =
