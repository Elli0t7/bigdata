                  ...
                  <div class="c-t">
                    <div class="c-t-box fit">
                      <div class="ct-t-t ">天气预报</div>                                                                                                           
                       <iframe width="0" scrolling="no" height="0" frameborder="0" allowtransparency="true" src="//i.tianqi.com/index.php?c=code&id=19&icon=1&temp=1&num=5&site=19&py=gaochun"></iframe>
                    </div>
                  </div>
                </div>
                <div class="col-10">
                ...
                <div class="col-10">
                  <div class="row fit" style="padding-top:2vh">
                    ...
                    <div class="col-6 overflow-hidden">
                      <iframe name="weather_inc" src="http://i.tianqi.com/index.php?c=code&id=55&py=gaochun" width="255" height="294"
...
<style>
  ...
  #mobile2{text-align:center;overflow:hidden;cursor: pointer;}

#mobile2 .wt{float:left;width:20%;padding-top: 2vh;}

#mobile2 .wt2{display: none; float:left;margin-top:1px;width:145px;padding-top: 3vh;}

#mobile2 .wtpic{width:100%; font-size: 2.2vh}

/* #mobile2 .wtpath{height:18px; line-height:18px; float:left; width:100%;} */

#mobile2 .wtpath,.wtwt,.wtfx{font-size: 1.8vh;line-height: 3.2vh; float:left; width:100%; text-align:center;overflow: hidden;}

#mobile2 .img{margin:3.6vh 22px;}

#mobile2 .day{ display: block;padding:2vh;}

#mobile2 .red{ color:#f7335e;}

#mobile2 .blue{ color:#06c;}
