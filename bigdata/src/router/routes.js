...
const routes = [
  ...
  {  
    ...
    children: [
      ...
      // {name:'overview', path: '', component: () => import('pages/front/home'),meta:{auth:true}},           
      ...
      {name:'broadcast',  path: 'broadcast', component: () => import('pages/front/broadcast'),meta:{auth:true,isHideMonitor:true} }, 
